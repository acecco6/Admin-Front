  ...
  <q-page class="module-page">
    <div class="page-container">
      ...
      <div class="page-header">
        <div class="header-content">
          <div class="title-section">
            <div class="icon-wrapper" style="background: linear-gradient(135deg, rgba(56,189,248,0.2), rgba(2,132,199,0.2)); border-color: rgba(56,189,248,0.3);">
      ...
      <div v-if="!sucursalId" class="empty-state">
        ...
        <p class="empty-text">Elegí la sucursal que querés administrar para ver las opciones de cobro.</p>
      </div>
      ...
      <template v-else>
        ...
        <div class="mode-tabs">
          ...
          <div
            ...
            @click="modoActivo = 'tienda'; cargarVentas()"
          >
        ...
        <div v-if="modoActivo === 'reservas'" class="tab-content">
          <div class="filters-bar">
            ...
            <q-btn flat dense icon="refresh" color="primary" round @click="cargarReservas" :disable="!tipoCanchaId">
          ...
          <div v-if="!tipoCanchaId" class="empty-state">
            ...
            <p class="empty-text">Elegí el tipo de cancha y la fecha para ver las reservas del día.</p>
          </div>
                ...
                <div class="turnos-list">
                  ...
                  >
                    ...
                    <div class="turno-meta">
                      ...
                      #{{ turno.reserva_id }}
                      <q-chip v-if="turno.pago_monto" dense color="positive" text-color="white" size="xs">Pagado</q-chip>
                    </div>
        ...
        <div v-if="modoActivo === 'tienda'" class="tab-content">
          ...
          <div v-else-if="!ventas.length" class="empty-state">
            ...
            <p class="empty-text">No hay ventas de tienda pendientes de cobro para esta sucursal.</p>
          </div>
          ...
          <div v-else class="ventas-list">
            ...
            <div
              v-for="venta in ventas" :key="venta.id"
              class="venta-card"
            ...
            >
              ...
              <div class="venta-total-right">${{ Number(venta.total).toLocaleString('es-AR') }}</div>
...
.mode-tab {
  ...
  font-size: 0.95rem; font-weight: 600; color: $text-muted;
  user-select: none;

  &:hover { border-color: rgba($primary, 0.4); color: $text-secondary; }
...
.tab-content { /* simplemente hereda */ }
...
.cancha-col-name { font-size: 0.9rem; font-weight: 700; color: $text-primary; }
.turnos-list {
...
.turno-pill {
  ...
  &:hover {
    background: rgba(56,189,248,0.14); border-color: rgba(56,189,248,0.45);
    transform: translateX(3px);
  }
}
.turno-time { font-size: 0.9rem; font-weight: 700; color: $text-primary; margin-bottom: 4px; }
.turno-meta { display: flex; align-items: center; gap: 5px; font-size: 0.75rem; color: $text-muted; }
.no-turnos { display: flex; align-items: center; gap: 8px; padding: 20px 8px; font-size: 0.83rem; color: $text-muted; justify-content: center; }

/* ── Ventas de tienda ── */
.ventas-list { display: flex; flex-direction: column; gap: 10px; }
.ventas-header-row { color: $text-muted; font-size: 0.85rem; font-weight: 600; margin-bottom: 4px; }
.ventas-count {}
...
.venta-title { font-size: 0.9rem; font-weight: 700; color: $text-primary; }
.venta-meta { display: flex; align-items: center; gap: 8px; font-size: 0.75rem; color: $text-muted; margin-top: 2px; }
.venta-meta--sin-nombre { font-style: italic; }
.venta-reserva-badge { display: flex; align-items: center; gap: 3px; }
.venta-total-right { font-size: 1rem; font-weight: 800; color: $text-primary; white-space: nowrap; }
</style>
