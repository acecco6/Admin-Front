...
function formatFecha(fecha) {
  if (!fecha) return ''
  // Si la fecha viene como YYYY-MM-DD, al hacer new Date(fecha) JS lo interpreta como UTC
  // y al mostrarlo en local (GMT-3) se resta tiempo y cambia de día.
  // Forzamos el horario local o usamos componentes de fecha.
